...
<div class="container-buscar mt-3">
    <div class="container-notificaciones-usuario">
        <h4>Usuarios</h4>
        <p>Total de usuarios registrados: <span class="badge badge-pill badge-primary"><?php echo $datos['cantidadUsuarios'] ?></span></p>
        <hr>
        ...
        <div class="lista-de-usuarios-registrados">
            <?php foreach($datos['allUsuarios'] as $usuariosRegistrados): ?>
                <div class="elemento-usuario-registrado">
                    <img src="<?php echo URL_PROJECT . '/' . $usuariosRegistrados->fotoPerfil ?>" alt="" class="image-big-user-usuario mr-2">
